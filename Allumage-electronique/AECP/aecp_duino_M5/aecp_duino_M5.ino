...
char ver[] = "version du 09_05_2017";//Choix entre 3 types de Dwell.
...
int Na[] = {0, 1300, 1700, 2160, 2600, 3040, 3480, 3760, 3940, 4000,7000, 0};
//degrés d'avance vilebrequin correspondant soit en tour volant moteur ( attention ! ):
int Anga[] = {0, 0, 2, 4, 6, 8, 10, 12, 14, 15, 15, 0}; 
