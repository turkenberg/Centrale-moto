...
char ver[] = "version du 06_10_2018";//Choix entre 3 types de Dwell.
...
//*******//*********Courbe   b
int Nb[] = {0, 1600, 2000, 2480, 3800, 4000, 4120,4240, 4360, 7000, 0}; //Courbe b 
int Angb[] = {0, 0, 2, 4, 10, 11, 12, 13, 14, 14, 0};
//*******//*********Courbe   c
int Nc[] = {0, 600, 2000, 3000, 3400, 3760, 3880, 3950, 4000, 7000, 0}; //Courbe c
int Angc[] = {0, 0, 6, 10, 12, 14, 15, 16, 18, 18, 0};
//*******//*********Courbe   d
int Nd[] = {0, 1600, 2520, 2840, 3660, 3760, 3880, 3990, 4000, 7000, 0}; //Courbe d
int Angd[] = {0, 0, 6, 8, 10, 14, 15, 16, 18, 18, 0};
//*******//*********Courbe   e
int Ne[] = {0, 1200, 2000, 2800, 3320, 3800, 4000, 4120, 4240, 4360, 7000, 0}; //Courbe e
int Ange[] = {0, 0, 3, 6, 8, 10, 11, 12, 13, 14, 14, 0};
