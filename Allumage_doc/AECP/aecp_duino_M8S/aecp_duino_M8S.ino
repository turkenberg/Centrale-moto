...
char ver[] = "version du 16_06_2018";//Choix entre 3 types de Dwell.
...
{ 
  ...
  Stop_temps = micros();
  //adigitalWrite(Flash, 1); delayMicroseconds(tFlash); digitalWrite(Flash, 0);
...
{ AngleCibles = 720 / Ncyl; //Ex pour 4 cylindres 180°, et 120° pour 6 cylindres
  ...
  RDzero = float(AngleCapteur - Avancestatique - Avancedemarrage + Decalavancestatique) / float(AngleCibles);
